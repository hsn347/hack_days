...
class BotManager:
    ...
    async def perform_comprehensive_query(self) -> AccountContext:
        ...
        try:
            ...
            ctx.alliance_treasure_can_receive = (len(at_st.get("can_receive_list", [])) + len(at_st.get("can_receive_help_rewards", []))) > 0
    ...
    async def step_22_prestige_task(self) -> Dict[str, Any]:
        ...
        تنفيذ مهمة مهام الهيبة اليومية داخل القلعة (Daily Prestige Quests):
          ...
          - تبديل القمح بوسام الحرب (CMD 1067/2) مرة واحدة يومياً.
